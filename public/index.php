...
<main class="main-content">
    <div class="contenedor-centrado">
        ...
        <form method="GET" class="busqueda">
            ...
            <a href="<?php echo base_url('/'); ?>" class="limpiar">Limpiar</a>
        </form>
        ...
        <div class="listado-libros">
            ...
            <?php if (!empty($libros)): ?>
                <?php foreach($libros as $libro): ?>
                    <div class="card">
                        ...
                        <div class="contenido-card">
                            ...
                            <a href="<?php echo base_url('/libro?id=' . s($libro->id)); ?>" class="boton-azul-block">
                                Ver Detalles
                            </a>
                        </div>
                    </div>
                ...
                <?php else: ?>
                    ...
                    <p class="sin-resultados">No se encontraron resultados para: "<?php echo s($termino); ?>"</p>
            <?php endif; ?>
        </div>
    </div>
